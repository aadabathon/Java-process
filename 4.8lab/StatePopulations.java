...
public class StatePopulations {
   ...
   public static void main(String[] args) throws IOException {
      ...
      for (i = 0; i < zipCodeState.size(); ++i) {
       if (zipCodeState.get(i).getKey().equals(myZipCode)){
        k = zipCodeState.get(i).getValue();
        break;
       }
      }
      ...
      for (i = 0; i < abbrevState.size(); ++i) {
        if (abbrevState.get(i).getKey().equals(k)) {
                S = abbrevState.get(i).getValue();
                break;
            }
      }
      ...
      for (i = 0; i < statePopulation.size(); ++i) {
         if (statePopulation.get(i).getKey().equals(S)) {
